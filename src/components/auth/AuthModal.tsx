    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="card-dreamy max-w-md w-full space-y-6 animate-fade-in">
        ...
        <button
          ...
          className="input-dreamy w-full flex items-center justify-center gap-3 py-3 rounded-lg border transition-opacity hover:opacity-90 disabled:opacity-60"
        >
          ...
          <span style={{ color: 'var(--celestial-white)' }}>
        ...
        <div className="relative">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t" style={{ borderColor: 'rgba(240, 244, 248, 0.2)' }} />
          </div>
          <div className="relative flex justify-center">
            <span className="px-3 text-sm" style={{ color: 'rgba(240, 244, 248, 0.6)', backgroundColor: 'rgba(26, 26, 46, 0.8)' }}>or</span>
          </div>
        </div>
